...
17 Dec 2019 by [James Munns](https://interrupt.memfault.com/authors/james)
...
This post is meant as a complement to the original [Zero to main()](https://interrupt.memfault.com/blog/zero-to-main-1) post on the Interrupt blog, and will elide some of the explanations of hardware level concepts. If you’re new to embedded development, or haven’t seen that post, go read it now!
...
This section of code initializes our `.data` section, copying directly from the `.rodata` section. This is similar to the code above, however we also walk the pointer in the initialiser section as well as the pointer in the destination section.
